    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      <header className="bg-[#0C2340] text-white p-4 flex justify-between items-center shadow-md">
        <div className="flex items-center gap-3">
          <Briefcase className="text-[#F1C400]" />
          <h1 className="font-bold text-xl">Secretary Portal</h1>
        </div>
        <form action={logout}>
      ...
      <main className="flex-1 p-8">
        <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-8 h-full flex flex-col items-center justify-center text-center">
          <h2 className="text-2xl font-bold text-slate-800 mb-2">Welcome Secretary</h2>
          <p className="text-slate-500 max-w-md">Use this portal to submit blind booking requests exclusively for Multi-Purpose Rooms.</p>
        </div>
      </main>
    </div>
  );
