...
const navigation = [
  { name: 'Manager Portal', href: '/manager', icon: LayoutDashboard, exact: true },
];
    ...
    <div className="flex h-screen overflow-hidden bg-slate-50">
      ...
      <aside className="w-64 shrink-0 bg-[#0C2340] text-blue-100 flex flex-col shadow-2xl z-20">
        <div className="p-6 border-b border-blue-900/50">
          ...
          <p className="text-xs text-blue-300 font-medium tracking-wider uppercase">Branch Manager</p>
        </div>
      ...
      <div className="flex flex-col flex-1 min-w-0 overflow-hidden">
        <header className="h-14 shrink-0 bg-white border-b border-slate-200 flex items-center px-8 justify-between shadow-sm z-10">
          <p className="text-sm font-semibold text-slate-600">Branch Manager Dashboard</p>
          <div className="flex items-center gap-3">
            <div className="h-8 w-8 rounded-full bg-[#F1C400] flex items-center justify-center text-[#0C2340] font-bold text-xs">
              BM
            </div>
          </div>
        </header>
